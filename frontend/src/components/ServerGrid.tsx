      ...
      >
        <Descriptions bordered column={2}>
          ...
          <Descriptions.Item label="Active Connections" span={2}>
            {hardware.network.active_connections.tcp_established} TCP /{" "}
            {hardware.network.active_connections.udp_active} UDP
          </Descriptions.Item>
    ...
    <>
      <GrafanaPanel
        ...
        badgeText={servers
          ...
          .length.toString()}
        status={
          servers.some((s) => s.status === "critical")
            ? "error"
            ...
            >
              ...
              <div style={{ marginBottom: "8px" }}>
                ...
                <Progress
                  ...
                  showInfo={false}
                  status={getProgressStatus(
                    server.hardware.cpu.utilization_percent,
                    70,
                    85
                  )}
                  strokeWidth={6}
              ...
              <div style={{ marginBottom: "8px" }}>
                ...
                >
                  ...
                  <Text style={{ fontSize: "11px", color: "#666" }}>
                    {server.hardware.memory.used_gb.toFixed(0)}GB /{" "}
                    {server.hardware.memory.total_gb.toFixed(0)}GB
                  </Text>
                </div>
                <Progress
                  ...
                  showInfo={false}
                  status={getProgressStatus(
                    server.hardware.memory.usage_percent,
                    80,
                    90
                  )}
                  strokeWidth={6}
              ...
              <div style={{ marginBottom: "12px" }}>
                ...
                >
                  ...
                  <Text style={{ fontSize: "11px", color: "#666" }}>
                    {server.hardware.storage.devices[0]?.usage_percent.toFixed(
                      0
                    )}
                    %
                  </Text>
                ...
                <Progress
                  percent={
                    server.hardware.storage.devices[0]?.usage_percent || 0
                  }
                  showInfo={false}
                  status={getProgressStatus(
                    server.hardware.storage.devices[0]?.usage_percent || 0,
              ...
              >
                <span>
                  Uptime:{" "}
                  {formatUptime(server.hardware.cpu.uptime_seconds || 86400)}
                </span>
                <Space>
                  <Tag color="blue">
                    {server.hardware.cpu.temperature_celsius.package.toFixed(0)}
                    °C
                  </Tag>
